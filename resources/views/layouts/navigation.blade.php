...
<div class="nav-header bg-white shadow-xs border-0">
    <div class="nav-top">
        <a href="{{ route('dashboard') }}"><i class="feather-zap text-success display1-size me-2 ms-0"></i><span
    ...
    <a href="{{ route('dashboard') }}" class="p-2 text-center ms-3 menu-icon center-menu-icon"><i
    ...
    <a href="{{ route('setting.default') }}" class="p-0 ms-3 menu-icon"><img
            src="https://via.placeholder.com/50x50.png" alt="user" class="w40 mt--1" /></a>
</div>
<!-- navigation top -->

                    ...
                    <div class="col-xl-8 col-xxl-9 col-lg-8">
                        <div class="card w-100 shadow-none bg-transparent bg-transparent-card border-0 p-0 mb-0">
                            <div class="owl-carousel category-card owl-theme overflow-hidden nav-none">
                                ...
                                <div class="item">
                                    <div class="card w125 h200 d-block border-0 shadow-xss rounded-xxxl bg-gradiant-bottom overflow-hidden mb-3 mt-3"
                                        style="
                          background-image: url(https://via.placeholder.com/200x300.png);
                        ">
                                        <div class="card-body d-block p-3 w-100 position-absolute bottom-0 text-center">
                                            <a href="#" data-target="#Modalstries" data-toggle="modal">
                                                <figure
                                ...
                                <div class="dropdown-menu dropdown-menu-start p-4 rounded-xxl border-0 shadow-lg"
                                    ...
                                    <div class="card-body p-0 d-flex">
                                        ...
                                        <h4 class="fw-600 text-grey-900 font-xssss mt-0 me-4">
                                            Save Link
                                            <span class="d-block font-xsssss fw-500 mt-1 lh-3 text-grey-500">Add this
                        ...
                        <div class="card w-100 shadow-xss rounded-xxl border-0 p-4 mb-3">
                            ...
                            <div class="card-body d-block p-0">
                                <div class="row ps-2 pe-2">
                                    <div class="col-xs-4 col-sm-4 p-1">
                                        <a href="https://via.placeholder.com/1200x800.png"
                                            data-lightbox="roadtrip"><img
                                                src="https://via.placeholder.com/1200x800.png" class="rounded-3 w-100"
                                                alt="image" /></a>
                                    </div>
                                    <div class="col-xs-4 col-sm-4 p-1">
                                        <a href="https://via.placeholder.com/1200x800.png"
                                    ...
                                    <div class="col-xs-4 col-sm-4 p-1">
                                        <a href="https://via.placeholder.com/1200x800.png" data-lightbox="roadtrip"
                                ...
                                <div class="dropdown-menu dropdown-menu-end p-4 rounded-xxl border-0 shadow-lg"
                                    ...
                                    <div class="card-body p-0 d-flex">
                                        <ul class="d-flex align-items-center justify-content-between mt-2">
                                            <li class="me-1">
                                                <a href="#" class="btn-round-lg bg-facebook"><i
                                                        class="font-xs ti-facebook text-white"></i></a>
                                            </li>
                                            <li class="me-1">
                                                <a href="#" class="btn-round-lg bg-twiiter"><i
                                                        class="font-xs ti-twitter-alt text-white"></i></a>
                                            </li>
                                            <li class="me-1">
                                                <a href="#" class="btn-round-lg bg-linkedin"><i
                                                        class="font-xs ti-linkedin text-white"></i></a>
                                            </li>
                                            <li class="me-1">
                                                <a href="#" class="btn-round-lg bg-instagram"><i
                                                        class="font-xs ti-instagram text-white"></i></a>
                                            </li>
                                            <li>
                                                <a href="#" class="btn-round-lg bg-pinterest"><i
                                                        class="font-xs ti-pinterest text-white"></i></a>
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="card-body p-0 d-flex">
                                        <ul class="d-flex align-items-center justify-content-between mt-2">
                                            <li class="me-1">
                                                <a href="#" class="btn-round-lg bg-tumblr"><i
                                                        class="font-xs ti-tumblr text-white"></i></a>
                                            </li>
                                            <li class="me-1">
                                                <a href="#" class="btn-round-lg bg-youtube"><i
                                                        class="font-xs ti-youtube text-white"></i></a>
                                            </li>
                                            <li class="me-1">
                                                <a href="#" class="btn-round-lg bg-flicker"><i
                                                        class="font-xs ti-flickr text-white"></i></a>
                                            </li>
                                            <li class="me-1">
                                                <a href="#" class="btn-round-lg bg-black"><i
                                                        class="font-xs ti-vimeo-alt text-white"></i></a>
                                            </li>
                                            <li>
                                                <a href="#" class="btn-round-lg bg-whatsup"><i
                                                        class="font-xs feather-phone text-white"></i></a>
                                            </li>
                                        </ul>
                                    </div>
                            ...
                            <div class="card-body d-flex p-0">
                                ...
                                <a href="#"
                                    class="d-flex align-items-center fw-600 text-grey-900 text-dark lh-26 font-xssss"><i
                                        class="feather-message-circle text-dark text-grey-900 btn-round-sm font-lg"></i><span
                                        class="d-none-xss">22 Comment</span></a>
                                <a href="#" id="dropdownMenu31" data-bs-toggle="dropdown"
                                    aria-expanded="false"
                                    class="ms-auto d-flex align-items-center fw-600 text-grey-900 text-dark lh-26 font-xssss"><i
                                        class="feather-share-2 text-grey-900 text-dark btn-round-sm font-lg"></i><span
                                        class="d-none-xs">Share</span></a>
                            ...
                            <div class="card-body d-block p-0 mb-3">
                                <div class="row ps-2 pe-2">
                                    <div class="col-xs-6 col-sm-6 p-1">
                                        <a href="https://via.placeholder.com/300x200.png" data-lightbox="roadtri"><img
                                                src="https://via.placeholder.com/300x200.png" class="rounded-3 w-100"
                                                alt="image" /></a>
                                    </div>
                                    <div class="col-xs-6 col-sm-6 p-1">
                                        <a href="https://via.placeholder.com/300x200.png" data-lightbox="roadtri"><img
                                ...
                                <div class="row ps-2 pe-2">
                                    ...
                                    <div class="col-xs-4 col-sm-4 p-1">
                                        <a href="https://via.placeholder.com/300x200.png" data-lightbox="roadtri"
                                            class="position-relative d-block"><img
                                                src="https://via.placeholder.com/300x200.png" class="rounded-3 w-100"
                                                alt="image" /><span
                                                class="img-count font-sm text-white ls-3 fw-600"><b>+2</b></span></a>
                            ...
                            <div class="card-body d-block p-0 mb-3">
                                <div class="row ps-2 pe-2">
                                    <div class="col-sm-12 p-1">
                                        <a href="https://via.placeholder.com/615x350.png" data-lightbox="roadtr"><img
                                                src="https://via.placeholder.com/615x350.png" class="rounded-3 w-100"
                                                alt="image" /></a>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card w-100 shadow-xss rounded-xxl border-0 mb-3 mt-3">
                            ...
                            <div class="card-body dd-block pt-0 ps-4 pe-4 pb-4">
                                <ul class="memberlist mt-1 mb-2 ms-0 d-block">
                                    <li class="w20">
                                        <a href="#"><img src="https://via.placeholder.com/50x50.png"
                                                alt="user" class="w35 d-inline-block" style="opacity: 1" /></a>
                                    </li>
                                    <li class="w20">
                                        <a href="#"><img src="https://via.placeholder.com/50x50.png"
                                                alt="user" class="w35 d-inline-block" style="opacity: 1" /></a>
                            ...
                            <div class="card-body d-flex pt-0 ps-4 pe-4 pb-3 overflow-hidden">
                                ...
                                <h4 class="fw-700 text-grey-900 font-xssss mt-2">
                                    ...
                                    <span class="d-block font-xsssss fw-500 mt-1 lh-4 text-grey-500">41 madison ave,
                                        floor 24 new work, NY 10010</span>
                                </h4>
                            </div>
